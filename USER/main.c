...
#define FLASH_APP1_MAX_ADDR				0x8036000
...
const char UDP_local_port[] = "4567";			//端口 
...
static u8 send_test_buf[4] = {1,2,3,4};
...
int main(void)
{
	...
	uip_ipaddr(ipaddr, 192,168,1,220);	//设置本地设置IP地址
